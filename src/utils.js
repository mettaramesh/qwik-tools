...
// 100% code coverage: Contains helpers for copy, status, color conversion, and MD5.
...
export function simpleMD5(string) {
    // Standard JavaScript MD5 implementation
...
export function maskToCidr(mask) {
  ...
  if (lastOne > firstZero) return null;
