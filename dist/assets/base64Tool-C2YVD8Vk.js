import{e as l}from"./index-DtWFcYz0.js";import{s as b}from"./domUtils-BxdcSh8e.js";function p(s){s.innerHTML=`
    ...
    `}function m(){const s=document.getElementById("base64-input"),o=document.getElementById("base64-output"),e=document.getElementById("base64-status"),i=t=>{t.preventDefault(),t.stopPropagation();try{o.value=l(btoa(unescape(encodeURIComponent(s.value)))),e.className="success-message",e.textContent="Text encoded successfully",e.classList.remove("hidden")}catch(d){e.className="error-message",e.textContent="Encoding failed: "+d.message,e.classList.remove("hidden")}},u=t=>{t.preventDefault(),t.stopPropagation();try{o.value=l(decodeURIComponent(escape(atob(s.value)))),e.className="success-message",e.textContent="Text decoded successfully",e.classList.remove("hidden")}catch{e.className="error-message",e.textContent="Decoding failed: Invalid Base64",e.classList.remove("hidden")}},r=t=>{t.preventDefault(),t.stopPropagation(),s.value="",o.value="",e.classList.add("hidden")},n=document.getElementById("base64-encode-btn"),a=document.getElementById("base64-decode-btn"),c=document.getElementById("base64-clear-btn");n&&n.addEventListener("click",i),a&&a.addEventListener("click",u),c&&c.addEventListener("click",r),typeof window.setupCopyButtons=="function"&&window.setupCopyButtons()}async function y(s,o){p(s),await b(()=>m(),["base64-input","base64-output"])}export{y as load,p as loadBase64Tool,m as setupBase64Tool};
